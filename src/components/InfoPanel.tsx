      ...
      >
        <div className="p-4 h-full flex flex-col">
          <div className="mb-4 pb-4 border-b border-gray-200">
            ...
            <div className="bg-gray-50 rounded-lg p-3">{legendComponent}</div>
          </div>
            ...
            <div className="space-y-4 text-sm text-gray-700">
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>Click nodes</strong> to select and view details
                  </li>
                  <li>
                    • <strong>Hover nodes</strong> to highlight connections
                  </li>
                  <li>
                    • <strong>Scroll</strong> to zoom in/out of the graph
                  </li>
                  <li>
                    • <strong>Click connections</strong> to view/edit relationship details
                  </li>
                  <li>
                    • <strong>Tab key</strong> to navigate between nodes
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>Single click:</strong> Select single node
                  </li>
                  <li>
                    • <strong>{shortcuts.multiSelect()}:</strong> Multi-select nodes
                  </li>
                  <li>
                    • <strong>Shift+Click:</strong> Select entire column
                  </li>
                  <li>
                    • <strong>{shortcuts.selectAllDisplay()}:</strong> Select all nodes (edit mode)
                  </li>
                  <li>
                    • <strong>Click empty space:</strong> Deselect all
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>Toggle edit mode</strong> with the edit button
                  </li>
                  <li>
                    • <strong>Double-click empty space</strong> to create new nodes
                  </li>
                  <li>
                    • <strong>Drag nodes</strong> to reposition them
                  </li>
                  <li>
                    • <strong>Select 2 nodes</strong> to preview/create connections
                  </li>
                  <li>
                    • <strong>Delete key:</strong> Remove selected nodes
                  </li>
                  <li>
                    • <strong>Arrow keys:</strong> Fine-tune node positions
                  </li>
                  <li>
                    • <strong>Left/Right arrows:</strong> Move between columns
                  </li>
                  <li>
                    • <strong>Up/Down arrows:</strong> Adjust vertical position
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>Info button (ⓘ):</strong> Edit node title and details
                  </li>
                  <li>
                    • <strong>Width slider:</strong> Adjust selected node width
                  </li>
                  <li>
                    • <strong>Color picker:</strong> Change node background color
                  </li>
                  <li>
                    • <strong>Text size slider:</strong> Scale text throughout graph
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>{shortcuts.undoDisplay()}:</strong> Undo last change
                  </li>
                  <li>
                    • <strong>{shortcuts.redoDisplay()}:</strong> Redo last change
                  </li>
                  <li>
                    • <strong>Tab/Shift+Tab:</strong> Navigate nodes
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-xs">
                  <li>
                    • <strong>Chat panel</strong> provides AI assistance
                  </li>
                  <li>
                    • <strong>Ask questions</strong> about your theory of change
                  </li>
                  <li>
                    • <strong>Request edits</strong> to nodes and connections
                  </li>
                  <li>
                    • <strong>Generate content</strong> for new sections
                  </li>
                </ul>
              </div>
            </div>
