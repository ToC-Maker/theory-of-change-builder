  ...
  return (
    <>
      ...
      >
        ...
        <div className={`relative border-b border-gray-200 ${isMobile ? 'p-4 pb-3' : 'flex-shrink-0 p-8 pb-4'}`}>
          ...
          <h2 className={`font-bold text-gray-900 ${isMobile ? 'text-xl mb-2' : 'text-4xl mb-2'}`} style={{ fontFamily }}>
            Connection Details
          </h2>
          <div
          ...
          >
            <div className={`text-gray-600 uppercase tracking-wide font-semibold ${isMobile ? 'text-xs mb-1' : 'text-sm mb-2'}`} style={{ fontFamily }}>
              Connection
            </div>
            <div className={`flex items-center ${isMobile ? 'gap-1' : 'gap-4'}`}>
              ...
              <div className="flex flex-col items-center flex-shrink-0">
                ...
                >
                  <svg className={`text-white ${isMobile ? 'w-2.5 h-2.5' : 'w-5 h-5'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5-5 5M6 12h12" />
                  </svg>
                </div>
                <div className={`text-gray-500 ${isMobile ? 'text-[8px] mt-0.5' : 'text-xs mt-1'}`} style={{ fontFamily }}>leads to</div>
              </div>
              <div
                className={`flex-1 rounded-lg border-0 text-center ${isMobile ? 'p-1.5 shadow-md' : 'p-3 rounded-xl shadow-[0_10px_15px_-3px_rgba(0,0,0,0.3),_0_4px_6px_-2px_rgba(0,0,0,0.15)]'}`}
        ...
        <div className={`flex-1 overflow-y-auto ${isMobile ? 'p-4' : 'p-8'}`}>
          ...
          <div>
            <h3 className={`font-semibold text-gray-800 ${isMobile ? 'text-lg mb-2' : 'text-2xl mb-3'}`} style={{ fontFamily }}>
              Confidence Level
            </h3>
            <div className={isMobile ? 'space-y-2' : 'space-y-4'}>
              <div className="text-center">
                <span className={`font-bold text-gray-800 ${isMobile ? 'text-xl' : 'text-2xl'}`} style={{ fontFamily }}>
