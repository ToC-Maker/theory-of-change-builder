// Single source of truth for Anthropic pricing used anywhere in the app.
//
...
// floats directly. Values verified against https://platform.claude.com/docs/en/about-claude/pricing.
